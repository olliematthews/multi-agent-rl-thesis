...
files = ['No_Norm.p', 'No_Norm_2.p', 'No_Norm.p']
nums = [0,0,1] 
# labels = ['Poly = ' + str(i) for i in range(2,5)]
labels = ['Fixed Normalisers - Large', 'Fixed Normalisers - Small', 'Adaptive Normalisers']
# labels = ['REINFORCE', 'Actor Critic', 'Actor Critic w/ Entropy Reg.']
...
# plt.legend()
# plt.show()
plot_iterations(rewards, labels, sigma, True, 'working_normaliser.pgf')
##
